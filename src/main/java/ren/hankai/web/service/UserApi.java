...
public class UserApi {
  ...
  @ResponseBody
  public ApiResponse login(@RequestParam("login_id") String loginId,
      @RequestParam("password") String password, @RequestParam("device_token") String deviceToken) {
    ...
    try {
      ...
      if (user == null) {
        ...
        ati.setExpiryTime(DateUtils.addDays(new Date(), SystemConfig.getApiAccessTokenExpiry()));
  ...
  @ResponseBody
  public ApiResponse sampleForAccessToken(@RequestParam("aaa") String aaa,
